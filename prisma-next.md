...
Your data contract is the heart of your application. It lives at [`src/config/prisma/schema.prisma`](src/config/prisma/schema.prisma) and describes your models:
...
```typescript
import { db } from './src/config/prisma/db';
...
export default definePrismaConfig({
  orm: ormConfig({
    contract: './src/config/prisma/schema.prisma',
    db: {
...
| File | Purpose |
|---|---|
| [`src/config/prisma/schema.prisma`](src/config/prisma/schema.prisma) | Your data contract — define your models here |
| [`prisma.config.ts`](prisma.config.ts) | CLI configuration |
| [`src/config/prisma/db.ts`](src/config/prisma/db.ts) | Database client — `import { db } from './src/config/prisma/db'` |
| `src/config/prisma/contract.json` | Compiled contract (generated) |
| `src/config/prisma/contract.d.ts` | Contract types (generated) |

### Workflow

1. Edit [`src/config/prisma/schema.prisma`](src/config/prisma/schema.prisma) to add or change models.
